	...
	public filmsList: Film[] = [
		{
			...
			rating_path: "/assets/films/rating.svg",
			favorite_path: "/assets/films/star.svg",
			watch_path: "/assets/films/like.svg",
			genre_ids: [878, 12, 28],
			id: 653346,
		...
		{
			adult: false,
			backdrop_path: "/assets/films/civil-war.jpeg",
			rating_path: "/assets/films/rating.svg",
			favorite_path: "/assets/films/star.svg",
			watch_path: "/assets/films/like.svg",
		...
		{
			adult: false,
			backdrop_path: "/assets/films/godzilla-x-kong.jpeg",
			rating_path: "/assets/films/rating.svg",
			favorite_path: "/assets/films/star.svg",
			watch_path: "/assets/films/like.svg",
			genre_ids: [878, 28, 12],
		...
		{
			adult: false,
			backdrop_path: "/assets/films/tarot-film.jpeg",
			rating_path: "/assets/films/rating.svg",
			favorite_path: "/assets/films/star.svg",
			watch_path: "/assets/films/like.svg",
			genre_ids: [27, 53],
